...
func _init() -> void:
	for kind in ["content.v1", "package.v1", "state.v1", "save.v1", "enemy-actions.v1", "progression.v1", "equipment.v1", "battle-layout.v1", "battle-layout.v2", "battle-ui.v1", "battle-hud.v1", "battle-canvas.v1", "attack-formula.v1", "attack-random.v1", "player-physical.v1", "training.v1", "enemy-physical.v1"]:
